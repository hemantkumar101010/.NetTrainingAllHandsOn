...
namespace ConsoleApp1
{
    public class program
    {
        ...
        private static void PrintAllEmployeesEducation()
        {
            ...
            {
                Console.WriteLine($"EducationId: {employeeEducation.ID}, CourseName: {employeeEducation.CourseName}, UniName: {employeeEducation.UniversityName}, Yop: {employeeEducation.PassingYear}, marks percentage:{employeeEducation.MarksPercentage}, empID: {employeeEducation.EmployeeID}");
            }
        }
    }
}